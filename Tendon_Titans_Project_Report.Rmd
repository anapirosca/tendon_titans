...
# Chunk 4A: Fit Models and Predict Normalized Forces
...
- Katie led the data collection and experimental setup, meticulously organizing and executing the tasks necessary for acquiring our data set.
- Jess contributed to the interpretation of our results, providing valuable insights that helped shape our discussion and conclusions.
